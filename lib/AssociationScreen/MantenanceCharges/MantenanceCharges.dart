...
class MantenanceCharges extends StatefulWidget {
  const MantenanceCharges({super.key});

  @override
  State<MantenanceCharges> createState() => _MantenanceChargesState();
}

class _MantenanceChargesState extends State<MantenanceCharges> {
  @override
              ...
              child: Column(
                children: [
                  _buildListItem(
                    ...
                    subtitle: "View paid, pending and overdue charge status",
                    onTap: () {
                      Navigator.push(
                        context,
                        CupertinoPageRoute(
